...
| data_primary_key              | The primary data key, this is used as the group id of the underlying SQS FIFO queue                                                                                                                                                  | `string`       | `null`  |    no    |
...
| redis_hash_key                | The key used to extract a value from the data and create a distinct record on                                                                                                                                                        | `string`       | `null`  |    no    |
| redis_security_group_id       | The security group id associated with the redis cluster                                                                                                                                                                              | `string`       | `null`  |    no    |
| slack_sns_arn                 | ARN of SNS topic to be used for alarms, alarms are trigger when messages end up on DQL                                                                                                                                               | `string`       | `null`  |    no    |
...
| path_value_filter             | The path of the data to filter specific records to Redis"                                                                                                                                                                            | `string`       | `null`  |    no    |
