...
| <a name="input_availability_zones"></a> [availability_zones](#input_availability_zones)                                                        |The availability zones for the vpc subnets. Only relevant if vpc_id has been specified                                                                   | `list(string)`      | ["us-west-2a", "us-west-2b", "us-west-2c"]       |    no    |   
