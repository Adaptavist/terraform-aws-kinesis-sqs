...
| <a name="input_redis_hash_key"></a> [redis_hash_key](#input_redis_hash_key)                                                        | The key used to extract a value from the data and create a distinct record on. If not selected the whole record will be hashed                                                                    | `list`      | null       |    no    |                                                                     | `list`      | null       |    no    |
